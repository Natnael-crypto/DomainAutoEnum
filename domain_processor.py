...
def resolve_domains_from_file(filename):
    ...
    try:
        ...
        # Write domain-to-IP table to CSV
        ...
        # Generate and print IP statistics table
        ...
        print(tabulate(ip_table, headers=["No.", "IP Address", "Count"], tablefmt="pretty"))

        # Write IP statistics to CSV
        ip_csv_data = [[row[1], row[2]] for row in ip_table]
        write_csv("ipaddress.csv", ip_csv_data, ["IP Address", "Count"])
